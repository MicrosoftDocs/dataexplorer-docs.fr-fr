...
ms.locfileid: "91452870"
---
# <a name="geo_distance_point_to_line"></a>geo_distance_point_to_line()

Calcule la distance la plus petite entre une coordonnée et une ligne ou une ligne multiligne sur la terre.
...
:::image type="content" source="images/geo-distance-point-to-line-function/us-south-coast-storm-events.png" alt-text="Distance entre l’aéroport et la route du Nord de Las Vegas":::
...
NY. Les Picks sont filtrés par une distance maximale de 0,1 mètres à partir de la ligne multiligne définie.

:::image type="content" source="images/geo-distance-point-to-line-function/madison-ave-road.png" alt-text="Distance entre l’aéroport et la route du Nord de Las Vegas":::
